...
..\..\..\..\..\..\vscode-amiga-debug\bin\win32\opt\bin\m68k-amiga-elf-gcc.exe -g -m68000  -nostdlib -Wextra -Wno-unused-function -Wno-volatile-register-var -fomit-frame-pointer -fno-tree-loop-distribution -fno-exceptions -ffunction-sections -fdata-sections -Wl,--emit-relocs,-Ttext=0 -Wa,--register-prefix-optional simple_c.cpp -o simple_c.elf
