@echo off
..\..\..\..\..\..\vscode-amiga-debug\bin\win32\opt\bin\m68k-amiga-elf-gcc.exe -mcpu=68000 -g -nostdlib -Wl,--emit-relocs,-Ttext=0 simple_c.cpp  -fomit-frame-pointer -o simple_c.elf
